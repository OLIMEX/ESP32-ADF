...
#define PIN_NUM_MISO 15		// SPI MISO
#define PIN_NUM_MOSI 2		// SPI MOSI
#define PIN_NUM_CLK  14		// SPI CLOCK pin
#define PIN_NUM_CS   21		// Display CS pin
...
#define PIN_NUM_RST  12  	// GPIO used for RESET control (#16)
...
// ** Set the correct configuration for Olimex's MOD-LCD2.8RTP
// ---------------------------------------------------------
#define DEFAULT_DISP_TYPE   DISP_TYPE_ILI9341
#define DEFAULT_TFT_DISPLAY_WIDTH   240
#define DEFAULT_TFT_DISPLAY_HEIGHT  320
